        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td>
                <i>
                  ...
                  Curious. Could it be that this was a race that was
                  exterminated by the Lazax?
                </i>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                Spend any number of trade goods. For each trade good spent, cast
                1 additional vote for the outcome on which you voted.
              </td>
              <td>
                <i>
                  "We think that this initiative would spell disaster for the
                  galaxy, not just the Creuss." Taivra said, quietly slipping
                  Z'eu an envelope. "Don't you agree?"
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <p>
                  During this invasion, apply -4 to the result of each
                  Bombardment roll against planets you control.
                </p>
              </td>
              <td>
                <i>
                  Elder Junn crossed his arms and steadied his breathing. The
                  bombs could not reach them, not this far down. At least, that
                  is what the soldiers had told him.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  Somehow, even after the Council had adjourned, none of them
                  were any closer to understanding the strange and confusing
                  events of the day.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <p>
                  You cannot vote on this agenda. Predict aloud an outcome of
                  this agenda. If your prediction is correct, place 1 space dock
                  from your reinforcements on a planet you control.
                </p>
              </td>
              <td>
                <i>
                  The vote was nearly unanimous. The council would provide
                  funding for the restoration. Ciel was furious.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <p>
                  ...
                  ship's combat value, your opponent must choose and destroy 1
                  of their ships.
                </p>
              </td>
              <td>
                <i>
                  Coughing up blood and covered in burns, Havvat collapsed
                  against the rapidly overheating ship core. She smiled. She
                  would be remembered.
                </i>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <p>
                  You cannot vote on this agenda. Predict aloud an outcome of
                  this agenda. If your prediction is correct, choose 1 system
                  that contains a planet you control. Each other player places a
            ...
            <tr>
              ...
              <td>
                <i>
                  ...
                  firing a volley directly into the flickering starboard shield
                  of the Letnev dreadnought.(3) For a moment, it looked as if
                  the dreadnought's shield would hold, but a moment later, the
                  ship began to come apart where the attack had pierced its
                  hull.(4) Neekuaq watched, satisfied, as the ship was wracked
                  by a series of explosions from within, huge armored plates and
                  other debris hurtling off into the darkness.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>1</td>
              <td>
                At the start of an invasion in a system that contains 1 or more
                of your opponents' PDS units:
              </td>
              <td>
                <p>
                  Your opponents' PDS units lose Planetary Shield and Space
                  Cannon during this invasion.
                </p>
              </td>
              <td>
                <i>
            ...
            <tr>
              ...
              <td>
                <i>
                  Large sum of Hacan currency flowed freely into the project,
                  and somehow, defying all logic, the returns were even greater.
                </i>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                Choose 1 of your space docks that is either in or adjacent to
                that system. That space dock uses Space Cannon 5 (x3) against
            ...
            <tr>
              ...
              <td>
                <i>
                  ...
                  that I ken get ye there right quick."(2) There was a
                  low-pitched hum throughout the station and the gigantic, bulky
                  constructions on the hull spat blue flame. Massive ion
                  thrusters! So this was how the Saar moved the damned
                  things.(3) Mendosa grinned at the young Mentak pilot's
                  astonishment. "Mobility-the Clan's greatest strength. Ye'd be
                  amazed at how fast this thing ken go."(4) With a sound like
                  thunder and a flash of neon blue light, the thrusters
            ...
            <tr>
              ...
              <td>
                <i>
                  Stunned, Rin looked over the data, scarcely able to believe
                  what he was seeing. It was nothing short of a major
                  breakthrough. The Headmaster would be pleased.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>As an Action:</td>
              <td>
                Place 3 infantry from your reinforcements on 1 planet you
                control.
              </td>
              <td>
                <i>
            ...
            <tr>
              ...
              <td>
                <i>
                  ...
                  exaggerated. After all, the Creuss had no business this far
                  from the Shaleri passage, and usually kept to themselves.
                </i>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                chosen system can move through systems that contain other
                players' ships.
              </td>
              <td>
                <i>
                  The Barony ships seemed to defy reality, bending light around
                  them at impossible angles - naught but inky-black contours
                  could be seen.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  The Gashlai reactors proved to be extremely effective. With
                  the conversion rate practically doubled, the factories' output
                  was immense.
                </i>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>As an Action:</td>
              <td>
                Remove 1 token from another player's tactic pool and return it
            ...
            <tr>
              ...
              <td>
                <i>
                  ...
                  there was more to these humans than they had initially
                  thought.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  The ship's sensors showed that the ancient star-map had
                  somehow led them beyond the Mahact plateau.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  ...
                  struck the hull of the dreadnought. Moments later, the
                  starboard flank erupted in flames.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  (1) Something was wrong. T'esla sensed a flicker of movement
                  on the planet's surface, followed by a faint glint of light.
                  Reflexively, she veered her fighter to the side - an action
                  that saved her life.(2) The fighter's thruster boosted her
                  just out of the cannon's firing solution, and a metal slug the
                  size of a building rocketed past her crystalline ship.(3)
                  T'esla breathed a sigh of relief as the massive slug
                  disappeared into the distance. A touch slower and she would
                  have been annihilated.(4) The flickering red warning lights on
                  her control panel reflected in her scales as she regained her
                  composure. "Well," she said aloud. "Zat was close."
                </i>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <i>
                  ...
                  have done the impossible. I am proud to call you my brothers.
                  My equals. My betters." Harrugh's whiskers bristled with
                  energy as he spoke.(3) "Today we turn these invaders to ash
                  and take back what is ours!" Harrugh paused, noting the
                  murmurs of approval rippling through the ranks.(4) The
                  whispering gradually died down and his warriors watched
                  Harrugh expectantly. Every muscle in his body tensed, and he
                  thrust his gyro-spear skyward. "For Kenara!"
                </i>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                Roll 1 die for each infantry on that planet. For each result of
                6 or greater, destroy 1 of those units.
              </td>
              <td>
                <i>
            ...
            <tr>
              ...
              <td>
                <i>
                  The Winnu councilor breathed a sigh of relief. This
                  opportunity would not be wasted. The peace of the Lazax was
                  within grasp.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  The Dirzuga had managed to negotiate themselves into a
                  position of power amongst the other councilors, all of whom
                  still looked terribly uncomfortable in their presence.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  In the months that followed the report, the Council was quick
                  to censure the Jol-Nar for their unethical practices.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  Flames engulfed the shipyard, a vortex of fire and shrapnel
            ...
            <tr>
              ...
              <td>
                <i>
                  ...
                  neglected to inform the N'orr representative that the damage
                  was not nearly as severe as he was led to believe.
                </i>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                <p>
                  <i>
                    (2) trjn.desgn.ALIZARIN introduced itself to each data
                    nodes, incorporating them into its platform, expunging any
                    data it deemed a threat to the Virus.
                  </i>
                </p>
                <p>
                  <i>
                    (3) unit.desgn.BEELZEBUL followed the group of men through
                    the winding hallways until they stopped at an intersection.
                ...
                <p>
                  <i>
                    ...
                    eyes ablaze with rage. The entire plan had been turned on
                    its head. Such incompetence was unfathomable.
                  </i>
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  When the Coalition raiders had finally returned to their
                  ships, scarcely a bolt remained to salvage from the destroyed
                  vessel.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  (1) T'ro stared unflinching at the incoming barrage through
                  the bridge's observation deck. The shield would hold.(2) The
                  blast from the enemy's main cannon slammed into the space in
                  front of the warship, splitting into two streams across the
                  bow.(3) The ship's shields sizzled and sparked but remained
                  active despite the heavy assault.(4) As the assault died down
                  and it became clear that the ship sustained no major damage,
                  T'ro clicked his mandibles in anticipation. "Return fire!"
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>As an Action:</td>
              <td>
                Chose 1 non-home system that contains or is adjacent to 1 of
                your ships. Place a command token from another player's
                reinforcements in that system.
              </td>
              <td>
                <i>
                  Meian was practically aglow, wisps of her ether crackling with
                  delight. It was amazing what could be achieved with a
                  well-timed electromagnetic discharge.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                <p>
                  <i>
                    (3) T'ro gave the order, and the entire fleet withdrew
                    without question.
                  </i>
                </p>
                <p>
                  <i>
                    (4) "We have no choice, captain." Ciel looked nervous."We
                    must retreat."
                  </i>
                </p>
              </td>
            ...
            <tr>
              ...
              <td>
                <i>
                  At the end of the twelfth day, Rev returned home from the
                  summit in New Moscow feeling physically exhausted and mentally
                  drained. But she was also satisfied. They had a plan - finally
            ...
            <tr>
              ...
              <td>
                <i>
                  ...
                  flashed briefly across the screen before he spoke.
                  "Bombardment complete. All enemy installations have been
                  neutralized."
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  ...
                  occupied with the virus meant killing two birds with one
                  stone.
                </i>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>As an Action:</td>
              <td>
                Remove 1 of your command tokens from the game board and return
            ...
            <tr>
              ...
              <td>As an Action:</td>
              <td>
                Choose 1 hazardous planet. Exhaust that planet and destroy up to
                3 infantry on it.
              </td>
              <td>
                <i>
                  Another quake shook the planet, and a wave of dirt and rock
                  rose up to swallow the Tekklar legion.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>1</td>
              <td>
                After you activate a system that contains 1 or more of your
                ships:
              </td>
              <td>
            ...
            <tr>
              ...
              <td>As an Action:</td>
              <td>
                Exhaust 1 non-home planet controlled by another player. Then
                gain trade goods equal to its resource value.
              </td>
              <td>
                <i>
                  Harrugh leapt down from the ledge, gyro-spear blazing in the
                  sunlight. In front, the L1Z1X began to take notice. Behind his
                  warriors stood at the ready. Win or lose, this would be the
                  end.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                Discard that agenda and reveal 1 agenda from the top of the
                deck. Players vote on this agenda instead.
              </td>
              <td>
                <i>
                  Magmus batted the now charred corpse aside with the back of
                  his golden gauntlet. "The Muuat reject your proposal."
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>As an Action:</td>
              <td>
                Place 1 cruiser from your reinforcements in a system that
                contains 1 or more of your ships.
              </td>
              <td>
                <i>
                  The N'orr may not be the most proficient shipwrights, but the
                  willingness of their citizens to do their part far exceeds
                  that of the other great races.
                </i>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <i>
                  Hiari pressed the activation glyphs, and the ancient door
                  hissed open. As she stepped into the pitch-black interior of
                  the Mahact tomb, she felt a shiver of anticipation. Perhaps,
                  finally, she would find the Codex.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  "Unfortunately," Cinnabian said in a level voice, "the
                  Galactic Council requires the dispute be arbitrated by a truly
                  neutral party. As the Titans were still slumbering when your
                  war began, we will oversee your negotiations... instead of
                  your friends on Jord."
                </i>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                If you voted for or predicted another outcome, discard the
                agenda instead; the agenda is resolved with no effect and it is
                not replaced.<p>Then, exhaust all of your planets.</p>
              </td>
              <td>
                <i>
            ...
            <tr>
              ...
              <td>1</td>
              <td>
                After another player activates a system that contains 1 or more
                of your structures:
              </td>
              <td>
                Remove up to 2 of your ground forces from the game board and
                place them on a planet you control in the active system.
              </td>
              <td>
                <i>
            ...
            <tr>
              ...
              <td>When an agenda is revealed:</td>
              <td>
                Choose another player; that player must give you 1 promissory
                note from their hand.
              </td>
              <td>
                <i>
                  (1) The Arborec emissary leaned close, and Brother Milor
                  flinched at the faint whiff of decay. "You do not understand,"
                  Dirzuga Ohao rasped. "You must support this measure."(2)
                  Brother Milor shook his head. "The Brotherhood cannot support
                  your war against this extra-dimensional threat." Dirzuga Ohao
                  raised an eyebrow. "Are you certain?"(3) "It would be
                  unfortunate," the Arborec Dirzuga said, "if your supplies of
                  diraxium were to dry up. How would your fleet defend you if we
                  stopped supplying its fuel?"(4) "Damn you!" Brother Milor
                  hissed. "You leave us no choice but to fight in your war."
                  Dirzuga Ohao smiled, dead skin stretching over her teeth.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>As an Action:</td>
              <td>
                Return a non-unit upgrade, non-faction technology that you own
                to your technology deck. Then, research another technology.
              </td>
              <td>
                <i>
                  "I am sorry, Academician," Arbiter Berekon shrugged. "I am
                  sure psychoarchaeology is an interesting subject, but the
                  supreme leader feels your budget would be better spent on more
            ...
            <tr>
              ...
              <td>
                <i>
                  ...
                  "Check again. You may find your goods are trading for less
                  than you think."
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  "The field is too thick!" Sikosk gasped. Trrakan's plume
                  flared. "Not for me, and not for Iruth." A flick of his talon,
                  and the destroyer flipped and dove for the asteroid field.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>As an Action:</td>
              <td>
                Choose 1 or 2 of your infantry on the game board; replace each
                of those infantry with mechs.
              </td>
              <td>
                <i>
                  Sek'kus leapt from the trenches, the plasma projectors on her
                  Valkyrie ekoskeleton howling as they scoured the field ahead
                  of her.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                same type as 1 of your units that is participating in this
                combat.
              </td>
              <td>
                <i>
                  Varish and Cole completed the final linkages, activating the
                  field harvester. The cruiser's beams roared with renewed
                  power, cutting through the enemy ship.
                </i>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <i>
                  Xuange spread their hands over the captured harvester.
                  Mirroring their careful gestures, dark energy fields unfolded
                  and began delicately disassembling the device.
                </i>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                return them to your reinforcements; gain trade goods equal to
                the combined cost of those ships.
              </td>
              <td>
                <i>
            ...
            <tr>
              ...
              <td>
                <i>
                  Armored dropships crashed into the main dock. Hatches blew
                  open, and Captain Mentarion and her commando raider charged
                  into the facility's heart.
                </i>
              </td>
            </tr>
            <tr>
